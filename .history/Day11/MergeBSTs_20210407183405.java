public class MergeBSTs {
    ...
    public static BinarySearchTree.Node mergeBSTs(BinarySearchTree.Node node1, BinarySearchTree.Node node2) {
        ...
        BinarySearchTree.Node head = mergeLL(head1, head2);
        BinarySearchTree.Node root = BSTtoSortedDLL.DLLtoBinaryST(head);
        System.out.println("***************************");
        display(root);
        System.out.println("***************************");
        return root;
    ...
    public static void main(String[] args) {
        ...
        BinarySearchTree.Node root1 = tree1.getRoot();
        int[] pre2 = new int[] { 12, 8, 3, 9, 42, 32, 52 };
        BinarySearchTree tree2 = new BinarySearchTree(pre2);
        BinarySearchTree.Node root2 = tree2.getRoot();
        display(root1);
        display(root2);

        display(mergeBSTs(root1, root2));
    }
