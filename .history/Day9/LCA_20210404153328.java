...
public class LCA {
    ...
    public static BinaryTree.Node lowestCommonAncestor(BinaryTree.Node node1, BinaryTree.Node node2) {
    ...
    public static void main(String[] args) {
        ...
        path = roottoNodePath2(tree.root, 12);
        System.out.println();
        for (BinaryTree.Node node : path)
