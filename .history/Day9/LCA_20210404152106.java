...
public class LCA {
    ...
    public static ArrayList<Integer> roottoNodePath2(BinaryTree.Node node, int target, boolean res) {
        ...
        ArrayList<Integer> lr = roottoNodePath2(node.left, target, res);
        ArrayList<Integer> rr = roottoNodePath2(node.right, target, res);
