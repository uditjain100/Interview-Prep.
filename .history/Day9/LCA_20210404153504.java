...
public class LCA {
    ...
    public static BinaryTree.Node lowestCommonAncestor(BinaryTree.Node root, BinaryTree.Node node1,
            BinaryTree.Node node2) {

        ArrayList<BinaryTree.Node> p = roottoNodePath2(root, node1.data);
        ArrayList<BinaryTree.Node> p = roottoNodePath2(root, node2.data);
