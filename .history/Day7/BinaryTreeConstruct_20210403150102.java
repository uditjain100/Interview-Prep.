public class BinaryTreeConstruct {
    ...
    public static Node constructorUsingPreAndIn(int[] pre, int psi, int pei, int[] in, int isi, int iei) {
        ...
        nn.right = constructorUsingPreAndIn(pre, psi + 1, pei, in, idx + 1, iei);
        return nn;
    }

    public static Node constructorUsingPostAndIn(int[] pre, int psi, int pei, int[] in, int isi, int iei) {
