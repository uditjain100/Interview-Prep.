...
public class BinaryTreeConstruct {
    ...
    public static Node constructorUsingPreAndPost(int[] pre, int prsi, int prei, int[] post, int posi, int poei) {
        ...
        nn.left = constructTreeFromPostAndIn(preOrder, prsi + 1, prsi + totalNoOfElements, postOrder, posi, idx);
        nn.right = constructTreeFromPostAndIn(preOrder, prsi + totalNoOfElements + 1, prei, postOrder, idx + 1,
                poei - 1);
