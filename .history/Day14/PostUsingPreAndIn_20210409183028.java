...
public class PostUsingPreAndIn {
    ...
    public static void getInOrder(int[] post, int[] pre, int posi, int poei, int prsi, int prei) {
        ...
        getInOrder(post, pre, posi, idx, prsi + 1, prsi + noe);
        if (posi == poei) {
            res.add(post[posi]);
            return;
        }
        ...
        getInOrder(post, pre, idx + 1, poei - 1, prsi + noe + 1, prei);
    ...
    public static void main(String[] args) {
        ...
        getInOrder(new int[] { 3, 9, 7, 32, 52, 42, 12 }, new int[] { 12, 7, 3, 9, 42, 32, 52 });
    }
