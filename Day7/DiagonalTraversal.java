...
public class DiagonalTraversal {
    ...
    public static ArrayList<Integer> bottomView(BinaryTree.Node node) {
    ...
    public static ArrayList<ArrayList<Integer>> diagonalView(BinaryTree.Node node) {
        ...
        while (!queue.isEmpty()) {
            ...
            while (size-- > 0) {
                ...
                if (rp.node.left != null)
                    queue.addLast(new Pair(rp.node.left, rp.level - 1));
                if (rp.node.right != null)
                    queue.addLast(new Pair(rp.node.right, rp.level));
            }
        }
        return res;
    }

    public static ArrayList<ArrayList<Integer>> antidiagonalView(BinaryTree.Node node) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(diagonalView(tree.root));
        System.out.println(antidiagonalView(tree.root));
    }
